        ...
        <div className='flex-col w-full flex gap-2 h-[670px]'>
            ...
            <div className='w-full h-full p-3 flex flex-col gap-4'>
                <div className='flex h-auto gap-2'>
                    <Input aria-label='customer-search-input' variant='bordered' radius='lg' size='lg' className='w-full h-full' placeholder='Cari customer...' onChange={searchCustomer}>Search</Input>
                ...
                <div className='w-full h-full'>
                    <CustomerTable refresh={refresh} search={search} />
                </div>
            </div>
