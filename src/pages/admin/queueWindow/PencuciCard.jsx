        ...
        <div key={data.id} className='w-1/4 h-full p-2'>
            <div className='w-full h-full bg-gray-100 rounded-xl flex flex-col relative'>
                ...
                <div className='w-full h-3/4 rounded-b-xl'>
                    <div className='w-full h-1/2 bg-gray-200 flex flex-col justify-center items-center gap-3 py-2'>
                        <div className='text-6xl'>{data.nomor_antrian != 0 ? data.nomor_antrian : '--'}</div>
                    </div>
                ...
                <div className={clsx('absolute top-3 left-0 w-4 h-8 text-xs rounded-r-xl text-center py-2 ', flagKedatangan())}>                  
                </div>
            </div>
        </div>
    )
